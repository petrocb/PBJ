...
class SMAFollowTrend:
    def __init__(self):
        self.id = 0
        self.data = functions.startPastPricesList(4097, "EUR_USD", "M30", "SMAFollowTrend")
        self.direction = 0
        self.position = 0
    ...
    def tick(self):
        ...
        self.data = functions.updatePastPrices2(self.data, 4097, "EUR_USD", "M30", "SMAFollowTrend")
