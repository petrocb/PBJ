...
class highResLongTrend:
    def __init__(self, account):
        ...
        self.smaLow = 29
        self.smaHigh = 31
        self.data = functions.startPastPricesList(self.smaHigh, "EUR_USD", "D1", self.account)
        self.direction = 0
        self.position = 0
    ...
    def tick(self):
        if self.account == "test":
            functions.update()
        self.data = functions.updatePastPrices2(self.data, self.smaHigh, "EUR_USD", "D1", self.account)
